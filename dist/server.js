...
app.post("/payment/create-intent", async (req, res) => {
    ...
    try {
        ...
        const orderData = await fetch(`https://api.bigcommerce.com/stores/${process.env.BC_STORE_HASH}/v2/orders/${order.id}`, {
            method: "GET",
            headers: {
                "X-Auth-Token": process.env.BC_API_TOKEN,
                Accept: "application/json",
        ...
        const amountDecimal = (_b = (_a = unpackOrderData.total_inc_tax) !== null && _a !== void 0 ? _a : unpackOrderData.total_ex_tax) !== null && _b !== void 0 ? _b : unpackOrderData.order_amount;
...
app.post("/payment/confirm", async (req, res) => {
    ...
    try {
        ...
        const checkoutToken = (_a = tokenJson.data) === null || _a === void 0 ? void 0 : _a.checkoutToken;
        if (!checkoutToken) {
